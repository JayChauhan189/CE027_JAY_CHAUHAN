...
class WordTime {
  ...
  String? url;  // Vraible to Store the url
  ...
  Future<void> getTime() async {
    Response response =
        await get(Uri.parse('http://worldtimeapi.org/api/timezone/$url')); // ur: Asia/Kolkata
    ...
    // Setting the the Current date and time to the time property of the class..
