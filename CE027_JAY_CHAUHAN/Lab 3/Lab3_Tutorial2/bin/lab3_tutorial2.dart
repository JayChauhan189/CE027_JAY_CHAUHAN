...
/* 
  ...
  print(getMultipleArgument("Jay", "Chauhan"));
...
/*  
  ...
  print(getFullName("Jay", "Chauhan"));
  print(getFullName("Jay", "Chauhan", "Hello User"));
...
/* 
  ...
  print(getFullName("Jay", "Chauhan"));
  print(getFullName("Jay", "Chauhan", "Hi,"));
...
/*  
  ...
  print(greetingsNamedRequired(name: "Jay"));
...
/* 
  ...
  /// It will take Jay as argument and name variable will consider as String variables.
